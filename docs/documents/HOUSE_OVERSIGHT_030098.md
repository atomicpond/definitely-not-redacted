# HOUSE_OVERSIGHT_030098

## Document Metadata

**Bates Range:** HOUSE_OVERSIGHT_030098 to HOUSE_OVERSIGHT_030100  
**Pages:** 5  
...
- [Los Angeles Times](../entities/people/los-angeles-times.md) - 1 mention
- [David Boies](../entities/people/david-boies.md) - 1 mention
...
To: Dunlavey, Dean (OC) < >, 
Schecter, **Daniel** (CC) < , Mohebbi, 
Nima (LA) < 
<I  
Cc: #L&W BD PR (US) </W mailto:#>>, Wine, Jamie 
(NY) <__________________________________________________>>, Bruno, Nicole (NY) 
>>, Harris, Nicole (CH) 
...
the Dubai International Airport and taken t
```
...
- [HOUSE_OVERSIGHT_030101](HOUSE_OVERSIGHT_030101.md) - 69 shared entities
- [HOUSE_OVERSIGHT_030105](HOUSE_OVERSIGHT_030105.md) - 67 shared entities
